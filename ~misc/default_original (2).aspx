<%@ Page
  ...
  CodeBehind="default_original.aspx.cs"
...
<asp:Content ID="defaultContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:Table ID="tabSignIn" CssClass="tabSignIn" runat="server" Visible="false">
    ...
    <asp:TableRow>
      <asp:TableCell ColumnSpan="3">
        <asp:Button CssClass="button" ID="btnRegister" OnClick="btnRegister_Click" runat="server" Text="<%$  Resources:portal, register%>" Visible="false" />
