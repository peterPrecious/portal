<%@ Page
  ...
  CodeBehind="passwordFinder.aspx.cs"
  Inherits="portal.v7.facilitator.passwordFinder" %>
  ...
  <div class="divPage">
    ...
    <asp:Panel ID="panTop" CssClass="panTop" runat="server" DefaultButton="butSearch">
      ...
      <div class="thisTitle">
        ...
        Enter the Learner's Username or Last Name (can just be the starting fragment, ie "Smith" for "Smithers".
